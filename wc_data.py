...
GROUP_MATCHES = [
    ...
    ("A",3,"Czechia","Mexico","2026-06-26 01:00","Mexico City"),
    ("A",3,"South Africa","South Korea","2026-06-26 01:00","Monterrey"),
...
KNOCKOUT_MATCHES = [
    # r32 — تیم‌ها، ساعت‌ها و شهرها طبق جدول رسمی FIFA (آپدیت ۲۸ خرداد ۱۴۰۵)
    ("r32",73,"South Africa","Canada",              "2026-06-28 19:00","Los Angeles"),
    ("r32",74,"Germany",     "Paraguay",            "2026-06-29 20:30","Boston"),
    ("r32",76,"Brazil",      "Japan",               "2026-06-29 17:00","Houston"),
    ("r32",75,"Netherlands", "Morocco",             "2026-06-30 01:00","Monterrey"),
    ("r32",78,"Ivory Coast", "Norway",              "2026-06-30 17:00","Dallas"),
    ("r32",77,"France",      "Sweden",              "2026-06-30 21:00","New York"),
    ("r32",79,"Mexico",      "Ecuador",             "2026-07-01 01:00","Mexico City"),
    ("r32",80,"England",     "DR Congo",            "2026-07-01 16:00","Atlanta"),
    ("r32",82,"Belgium",     "Senegal",             "2026-07-01 20:00","Seattle"),
    ("r32",81,"United States","Bosnia and Herzegovina","2026-07-02 00:00","San Francisco"),
    ("r32",84,"Spain",       "Austria",             "2026-07-02 19:00","Los Angeles"),
    ("r32",83,"Portugal",    "Croatia",             "2026-07-02 23:00","Toronto"),
    ("r32",85,"Switzerland", "Algeria",             "2026-07-03 03:00","Vancouver"),
    ("r32",88,"Australia",   "Egypt",               "2026-07-03 18:00","Dallas"),
    ("r32",86,"Argentina",   "Cape Verde",          "2026-07-03 22:00","Miami"),
    ("r32",87,"Colombia",    "Ghana",               "2026-07-04 01:30","Kansas City"),
